...
public class CatScraperUserAge {
    
    private String name, hairLenght, gender, age, URL;

    public CatScraperUserAge(String name, String hairLenght, String gender, String age, String URL) {
        this.name = name;
...
class CatScraperDemoAge {
    public static void main(String[] args) throws IOException {
        ...
        System.out.print("Enter the max age for your cat --> ");
        int age = scan.nextInt();
        
        int count = 1;
        //print all cat objects
        for (Cat cat : cats) {
            if (Integer.parseInt(cat.getAge().substring(0, cat.getAge().indexOf(" ")))<= age) {
